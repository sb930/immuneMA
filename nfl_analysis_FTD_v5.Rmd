...
nfl_df3_incompletes3_con <- subset (nfl_df3_incompletes3_con, select = -c(l_iqr_nfl_con, u_iqr_nfl_con))
...
nfl_df4_all_con <- nfl_df4_incompletes_con
...
nfl_df3_incompletes3_ftd <- subset (nfl_df3_incompletes3_ftd, select = -c(l_iqr_nfl_ftd, u_iqr_nfl_ftd))
...
nfl_df4_all_ftd <- nfl_df4_incompletes_ftd
