...
data2 <- data_t[c(9,28,69,70,76,77)]
...
data2[data2 == ""] <- NA    
dat <- subset(data2, !is.na(mean_CHI3L.1_con))
...
df2 <- escalc(data=df2, measure="SMD", m1i=mean_CHI3L.1_con, m2i=mean_CHI3L.1_ftd,
                sd1i=SD_CHI3L.1_con, sd2i=SD_CHI3L.1_ftd,
